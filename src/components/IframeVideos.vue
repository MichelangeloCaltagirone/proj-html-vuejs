    ...
    <section id="section-iframe-wrapper" class="d-flex">
            <div class="left">
                ...
                <div class="iframe-wrapper">
                    ...
                    <div class="overlay">
                        <img id="cover-image" v-if="cover" @click="playVideo"
                            src="https://maxcoach-4437.kxcdn.com/main/wp-content/uploads/sites/1/2019/12/home-2-popup-video-poster.jpg"
                            alt="">
                        <div class="yt-button" v-if="cover" @click="playVideo">
                            <img src="https://maxcoach-4437.kxcdn.com/main/wp-content/uploads/sites/1/2019/11/icon-youtube-play.png"
                                alt="">
                        </div>
                    </div>
                    <!-- Iframe per mostrare il video youtube con metodi e animazioni-->
                    <iframe v-if="showVideo" @mouseleave="hideVideo"
                        src="https://www.youtube.com/embed/ElFJ1qcl74U?autoplay=1" frameborder="0"
                ...
                <div class="section-iframe-right">
                    ...
                    <div class="right-page-bottom-wrapper">
                        <div id="right-description-wrapper d-flex justify-content-center">
                            <div class="text">
                                <p>Sneek peek into what has in store for you on our online teaching and mentoring
